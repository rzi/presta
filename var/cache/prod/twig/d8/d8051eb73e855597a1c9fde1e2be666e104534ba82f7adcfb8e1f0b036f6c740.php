...
class __TwigTemplate_37240ae1f8c3ba79d9d772ad900e621420a835bc53058bfd1c7cc773480fbb0c extends \Twig\Template
{
    ...
    ";
        ...
        ";
            ...
            echo "',
                apiStockUrl: '";
            // line 55
            echo twig_escape_filter($this->env, ((($context["productId"] ?? null)) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_product_combinations", ["productId" => ($context["productId"] ?? null)])) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_products"))), "html", null, true);
            echo "',
                apiMovementsUrl: '";
            // line 56
            echo twig_escape_filter($this->env, ((($context["productId"] ?? null)) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_product_list_movements", ["productId" => ($context["productId"] ?? null)])) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("api_stock_list_movements"))), "html", null, true);
            echo "',
                employeesUrl: '";
            // line 57
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Stock/overview.html.twig", "/usr/home/rzi/domains/presta.ct8.pl/public_html/src/PrestaShopBundle/Resources/views/Admin/Stock/overview.html.twig");
    }
}
